...
{
	define("SITE_URL", "http://localhost/Marwar_Institute/admin/api/");
    define("ADMIN_PATH", "http://localhost/Marwar_Institute/admin/"); 
    define("BASE_PATH", "http://localhost/Marwar_Institute/");
    define("DOC_PATH", "/opt/lampp/htdocs/Marwar_Institute/admin/");
}
else
{
	define("SITE_URL", "https://technolite.in/staging/marwarinstitute/admin/api/");
    define("ADMIN_PATH", "https://technolite.in/staging/marwarinstitute/admin/"); 
    define("BASE_PATH", "https://technolite.in/staging/marwarinstitute/");
    define("DOC_PATH", "/var/www/vhosts/technolite.in/httpdocs/staging/marwarinstitute/admin/");
}

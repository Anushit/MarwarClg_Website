...
public function productlist_post(){  
    ...
    public function event_details_get($id=null){
        if ($this->input->server('REQUEST_METHOD') == 'GET') 
        {      
            $details_data = $this->events_model->get_event_by_slug($id);
    ...
    public function course_detail_get($id=null){
        if ($this->input->server('REQUEST_METHOD') == 'GET') 
        {      
            $details_data = $this->blogs_model->get_blog_by_slug($id);  
            if($details_data){
    ...
    public function news_details_get($id=null){
        if ($this->input->server('REQUEST_METHOD') == 'GET') 
        {      
            $details_data = $this->news_model->get_news_by_slug($id);  
            if($details_data){
